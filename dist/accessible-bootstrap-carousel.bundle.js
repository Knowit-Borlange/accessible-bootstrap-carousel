...
(function ($) {
    ...
    function initDescriptionPlacement() {
      $accesibleCarousels.each(function (index, value) {
        ...
        var $descriptionsWrapper = $this.find('.carousel-descriptions');
        var $descriptionItem = $this.find('.carousel-caption');
        ...
        if (descriptionPlacement != "under" || descriptionPlacement == null) {
          ...
          $descriptionItem.each(function (index, value) {
            var $el = '<li class="carousel-descriptions__item">' + $(this).html() + '</li>';
    ...
    function calculateDescriptionHeight() {
      $accesibleCarousels.each(function (index, value) {
        ...
        var descriptionPlacement = $this.data('description-placement');
        var $descriptionsWrapper = $this.find('.carousel-descriptions');
        var $descriptionItem = $this.find('.carousel-descriptions .carousel-descriptions__item');
    ...
    var $accesibleCarousels$1 = $('.accessible-carousel');

    function initCarouselPopupLayout() {
      $accesibleCarousels$1.each(function (index, value) {
        var $this = $(this);
        var $modalButton = $(this).find('.carousel-item__link');
        var carouselModal = $this.data('modal');

        if (carouselModal == true) {
          var iconButton = "<span class=\"btn btn-link carousel-item__open-modal-button\">\n                            <i class=\"icon fa fa-search-plus\"></i><span class=\"sr-only\">Se bilderna i st\xF6rre format</span>\n                        </span>";
    ...
    var $accesibleCarousels$2 = $('.accessible-carousel');

    var initAccessibleCarousels = function initAccessibleCarousels() {
      $accesibleCarousels$2.each(function (index, value) {
        var $this = $(this);
        ...
        $this.find('.carousel-tools__play-pause-button').on('click', function (e) {
          var pauseText = $(this).data('pause');
          var playText = $(this).data('play');
          ...
          if ($(this).hasClass('paused')) {
            ...
            var _text = playText;
            $(this).attr('data-original-title', _text);
        ...
        $this.find('.carousel-tools__hide-button').on('click', function (e) {
          var $toggleElements = $(elementId).find('.carousel-player, .carousel-descriptions, .carousel-tools__play-pause-button, .carousel-tools__indicators');
          ...
          if ($(this).hasClass('hidden')) {
            ...
            $(elementId).carousel('pause');
            var _text2 = showText;
            $(this).attr('data-original-title', _text2);
            $(this).find('span').text(_text2);
            $($toggleElements).hide();
          }
        });
      });
...
//# sourceMappingURL=accessible-bootstrap-carousel.bundle.js.map
